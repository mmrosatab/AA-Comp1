...
void giraTorre(int i)
{
    ...
    SDL_Surface *teste = rotozoomSurface(t1[0].surface, t1[0].angulo, 1.0, SMOOTHING_ON);
    
    rect.x -= teste->w/2 - t1[0].surface->w/2;
    rect.y -= teste->h/2 - t1[0].surface->h/2;

    i = i + 5;

    SDL_BlitSurface(teste,NULL, tela, &rect);
